    ...
    <div className="relative inline-block text-left w-24">
      <div>
        <button
          ...
          className={`inline-flex w-full items-center justify-center gap-1 rounded-md bg-white px-3 py-2 text-sm text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50`}
          id="menu-button"
