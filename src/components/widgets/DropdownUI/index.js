...
const DropdownUI = ({title, dataList, isOpen, handleMenuItemClick, handleToggleDropdown, activeItem, setActiveItem, setIsOpen}) => {
  return (
    <div className="relative inline-block text-left w-24">
      ...
      {isOpen && (
        <div
          className="absolute max-h-48 overflow-y-scroll right-0 z-10 mt-2 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
          role="menu"
