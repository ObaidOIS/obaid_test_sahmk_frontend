...
const InputFieldUI = ({label, placeholder, name, value, id, handleKeyUp, required, handleChange, maxlength, buttonStyle, inputmode, isValid, dir, handlePaste, autocomplete}) => {
  return (
    <div>
