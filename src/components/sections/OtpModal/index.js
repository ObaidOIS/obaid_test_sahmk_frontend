  ...
  return (
    <div>
        ...
        <div className='flex gap-4 my-5'>
            <InputFieldUI maxlength="1" onkeyup={focusNextInput} paramOne='code-1' paramTwo='code-2' id="code-1" buttonStyle="text-center" />
            <InputFieldUI maxlength="1" onkeyup={focusNextInput}  paramOne='code-1' paramTwo='code-3' id="code-2" buttonStyle="text-center" />
            <InputFieldUI maxlength="1" onkeyup={focusNextInput}  paramOne='code-2' paramTwo='code-4' id="code-3" buttonStyle="text-center" />
            <InputFieldUI maxlength="1" onkeyup={focusNextInput}  paramOne='code-3' paramTwo='code-5' id="code-4" buttonStyle="text-center" />
            <InputFieldUI maxlength="1" onkeyup={focusNextInput}  paramOne='code-4' paramTwo='code-5' id="code-5" buttonStyle="text-center" />
            </div>
            <div>
