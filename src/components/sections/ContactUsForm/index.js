...
const ContactUsForm = () => {
  ...
  useEffect(() => {
    if (token) {
      ...
      // validateToken(token);
      const response = apiCall(`/auth/api/create-captcha-assess/`, "POST", {
        project_id: "sahmk-403919",
        recaptcha_key: "6Lc0V2wpAAAAAKlSRbnE-wnSSyNS8lWZtLneBMou",
        // recaptcha_key: "6LfemHopAAAAALyxmZ19-12MERLr2pExp1eHdMly",
        token: token,
        recaptcha_action: "page_view",
      });
      if (response) {
        console.log(response, "token data");
    ...
    <div>
      ...
      {errorAlert == true && (
        <MessageAlert
          ...
          icon={
            <XCircleIcon className="h-5 w-5 text-redColor" aria-hidden="true" />
          }
        />
      )}
      <ReCaptchaProvider
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                <InputFieldUI
                  ...
                  type="text"
                  handleChange={(e) => handleChange("company", e.target.value)}
                />
              </div>
              <div className="sm:col-span-2">
                <InputFieldUI
              ...
              <div className="sm:col-span-2">
                <TextAreaUI
                  ...
                  name="message"
                  handleChange={(e) => handleChange("message", e.target.value)}
                />
              </div>
            </div>
            <div className="mt-10">
